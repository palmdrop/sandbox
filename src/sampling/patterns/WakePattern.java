...
public class WakePattern extends AbstractPattern {
    ...
    public WakePattern(double baseFrequency, double threshold, double thinness, double lacunarity, double persistence, int warp, boolean stretch) {
